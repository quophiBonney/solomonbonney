...
import btube from "../../public/btube.PNG";
  ...
  return (
    <div className="col-12 mb-5">
      <div className="card shadow border-0 project-card">
        <Image src={btube} alt="" className="img-fluid card-img-top" />
        <div className="px-3 mt-3">
          <h5 className="h-4 fw-bold text-uppercase text-black">BTube</h5>
