  ...
  return (
    <div className="card shadow border-0">
      ...
      <div className="px-3 mt-3">
        ...
        <p className="p px-2">
          This platform provides you with million of quotes that inspire you and
          also cause you to achieve greatness in whatever you do. It comes with
          friendly and awesome interface that you can easily find your way out.
          Join the few people that step out every day with new mindset, energy
          and positivity. Staying focused, consistent, discipline and motivated
          can really help you transform your life for years and you can do so by
          reading content to give you such things.
        </p>
        <Link
          href=""
